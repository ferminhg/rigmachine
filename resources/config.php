<?php
/*
    Basado en http://net.tutsplus.com/tutorials/php/organize-your-next-php-project-the-right-way/
...
$config = array(
    ...
    "urls" => array(
        "baseUrl" => "http://rigmachine.com"
    ),
    "paths" => array(
        "resources" => "/var/www/rigmachine/resources",
        "images" => array(
